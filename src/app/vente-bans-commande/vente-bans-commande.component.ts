...
@Component({
  selector: 'vente-bans-commande',
  templateUrl: './vente-bans-commande.component.html',
  styleUrls: ['./vente-bans-commande.component.css']
})
export class VenteBansCommandeComponent implements OnInit {
