...
@Component({
  selector: 'vente-bans-livraison',
  templateUrl: './vente-bans-livraison.component.html',
  styleUrls: ['./vente-bans-livraison.component.css']
})
export class VenteBansLivraisonComponent implements OnInit {
